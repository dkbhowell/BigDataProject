...
//make sure price is listed
	...
	Integer sqFeetInt=Integer.parseInt(sqFeet);
	Integer priceInt=Integer.parseInt(price);
	Integer pricePerFoot=priceInt/sqFeetInt;
	String date = field[20];
	String year = date.replace("[^/]*/[^/]*/", "");
	String yearBoro = field[0]+year;
	context.write(new Text(yearBoro), new IntWritable(pricePerFoot));
